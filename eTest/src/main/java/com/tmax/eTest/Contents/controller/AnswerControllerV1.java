...
public class AnswerControllerV1 {
	...
	@PostMapping(value="/problems/{id}/answer-check/depricated", produces = "application/json; charset=utf-8")
	public int checkAnswer(@RequestParam("id") Integer id, @RequestBody ArrayList<StatementDTO> lrsbody) throws Exception {
		logger.info("answer-check request received!");
