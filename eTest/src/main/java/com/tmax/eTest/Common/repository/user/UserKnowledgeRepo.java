...
public interface UserKnowledgeRepo extends JpaRepository<UserKnowledge, UserKnowledgeKey>{
	...
	@Query("select uk from com.tmax.eTest.Common.model.user.UserKnowledge uk where uk.userUuid = :userUuid")
	List<UserKnowledge> findListByUserUuid(@Param("userUuid") String userUuid);
}
