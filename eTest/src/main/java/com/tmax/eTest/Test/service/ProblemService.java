...
import com.tmax.eTest.Test.repository.ProblemDemoRepository;
import com.tmax.eTest.Test.repository.ProblemSetRepository;
...
public class ProblemService {
	...
	public List<Map<String, String>> getNextProblemSet(String userId, String diagType, String part, String is_adaptive){
		...
		UserMaster dao = userService.getUserInfo(userId);
