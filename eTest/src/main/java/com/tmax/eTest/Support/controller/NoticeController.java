...
public class NoticeController {
    ...
    @PostMapping(value = "/notice/update/view")
    public CMRespDto<?> updateNoticeView(@RequestBody UpdateNoticeViewDto updateNoticeViewDto) {
        return noticeService.updateNoticeView(updateNoticeViewDto);
    }
}
