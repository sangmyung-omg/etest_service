...
public class DiagnosisComment {
	...
	public Map<String, String> makeRiskMainComment(int profileScore, int tracingScore)
	{
		...
		String[] riskMainComment = {
				"당신은 위험을 감수하면서 특정 종목에 집중투자하는 성향으로 보입니다. 집중투자는 높은 수익률을 기대할 수 있지만 그만큼 리스크도 감수해야 합니다. 투자기간을 단기적으로 설정하는 경향이 있는데, 시장의 흐름과 경기변화를 민감하게 파악하고 분석하는 자세가 필요합니다.",
				"당신은 위험을 감수하면서 특정 종목에 집중투자하는 성향으로 보입니다. 집중투자는 높은 수익률을 기대할 수 있지만 그만큼 리스크도 감수해야 합니다. 투자기간을 단기적으로 설정하는 경향이 있는데, 시장의 흐름과 경기변화를 민감하게 파악하고 분석하는 자세가 필요합니다.",
				"당신은 위험을 감수하면서 높은 수익률을 추구하고 여러 종목에 분산하여 투자하는 경향을 보입니다. 저평가된 주식을 골라 고평가되기 전에 파는 가치투자를 선호할 수 있습니다. 여러 고위험 종목 투자가 늘어갈 수 있기 때문에, 늘 수익률을 점검하고 조정하는 태도를 갖는게 좋습니다.",
				"당신은 손실위험을 최소화하는 안정적인 투자를 선호하며, 확실하다고 판단하는특정 종족 중심으로 투자하는 경향이 있습니다. 기업안정성이 높은 우량주 위주로 투자하는 성향을 보입니다. 손실을 최소화하려는 성향 때문에 가격 변동이 커졌을때 대응에 어려움을 겪을 수 있습니다. 투자한 종목의 시장 현황과 기업 상황을 지속적으로 분석하여 변수를 미리 준비한다면 더욱 안정적인 투자에 도움이 될겁니다.",
				"당신은 공격적일때는 공격적으로, 보수적일때는 보수적으로 상황에 맞게 투자방법을 결정하는 경향이 있습니다. 대체로 내가 감당할 수 있는 범위 내에서 투자하는 것을 선호하며, 나의 위험성향과 실제 투자 방식이 상당부분 일치하기 때문에 주변 사람들이 봤을때는 안정적으로 투자하는 사람으로 보이기도 합니다.",
				"당신은 위험을 감수하면서 높은 수익률을 추구하고 여러 종목에 분산하여 투자하는 경향을 보입니다. 저평가된 주식을 골라 고평가되기 전에 파는 가치투자를 선호할 수 있습니다. 여러 고위험 종목 투자가 늘어갈 수 있기 때문에, 늘 수익률을 점검하고 조정하는 태도를 갖는게 좋습니다.",
				"당신은 손실위험을 최소화하는 안정적인 투자를 선호하며, 확실하다고 판단하는특정 종족 중심으로 투자하는 경향이 있습니다. 기업안정성이 높은 우량주 위주로 투자하는 성향을 보입니다. 손실을 최소화하려는 성향 때문에 가격 변동이 커졌을때 대응에 어려움을 겪을 수 있습니다. 투자한 종목의 시장 현황과 기업 상황을 지속적으로 분석하여 변수를 미리 준비한다면 더욱 안정적인 투자에 도움이 될겁니다.",
				"당신은 리스크를 짊어지기 보다 손실을 최소화하여 안정적 수익을 추구하며, 분산투자를 선호하는 것으로 보입니다. 기대수익률이 낮더라도 미래 원금보전이 확실한 종목과 상품에 안정감을 느낍니다. 분산투자를 하는 이유도 위험을 줄이려는 목적이 크며, 기업안정성이 높은 우량주 위주로 투자하는 성향을 보입니다.",
				"당신은 리스크를 짊어지기 보다 손실을 최소화하여 안정적 수익을 추구하며, 분산투자를 선호하는 것으로 보입니다. 기대수익률이 낮더라도 미래 원금보전이 확실한 종목과 상품에 안정감을 느낍니다. 분산투자를 하는 이유도 위험을 줄이려는 목적이 크며, 기업안정성이 높은 우량주 위주로 투자하는 성향을 보입니다."};
	...
	public List<Object> makeRiskDetailComment(int profileScore, int tracingScore)
	{
		...
		String[] profileDetailList = {
				"당신은 손실 위험을 감수하면서 높은 수익률을 추구하는 공격투자형 입니다. 예상 시익이 높다고 판단하면, 위험이 있는 상품에 투자를 하거나 주식의 특정 종족에 집중하여 투자를 하는 경향도 있습니다. 공격투자형은 항상 본인의 투자를 점검해보는 자세가 필요합니다. 한 두번 투자에 성공하면 자기확신 편향에 빠지기 쉽고 위험에 둔감해 질수 있습니다. 또한 하루하루 수익률에 일희일비하지 않고 확고한 투자원칙을 기반으로 투자하는 자세가 필요합니다.", 
				"당신은 리스크 중립형으로 위험을 적당하게 수용하고 인내하는 투자자입니다. 투자에는 그에 상응하는 투자위험이 있음을 인식하며 예적금보다는 높은 수익률을 추구합니다. 리스크 중립형 투자자는 지금 하고 있는 투자방법이 자신에게 익숙한지 확인해볼 필요가 있습니다. 투자 후 계속 주식앱을 보며 불안에 떨고 있다면 안정투자형에 가깝고, 만족스럽지 못한 수익에 밤잠을 설치면 공격적투자형에 가깝습니다. 어느때는 안정투자형, 어떤 때는 공격적투자형에 가까울 수 있기 때문에, 투자방법을 수시로 조정할 수 있도록 준비도 필요합니다.", 
		...
		String[] tracingDetailList = {
				"당신은 적은 종목의 수를 보유하면서 수익률을 추구하는 집중 투자를 하고 있을 확률이 높습니다. 집중투자는 적은 종목들의 수익률에 의존하기 때문에 수익폭이 매우 큰 특징이 있습니다. 적은 종목에 투자하기 때문에 리스크가 상대적으로 크다는 것을 인지하고 투자 종목을 선택할 때 충분히 분석하고 고민해야 합니다.", 
				...
				"당신은 특정 종목 몇 개에 집중하기 보다는 최대한 분산하여 투자하면서 위험을 줄이는 투자성향을 가지고 있습니다. 경기민감주와 경기와 무관한 업종을 섞어서 담는 등 업종을 분산하거나 국내 뿐만 아니라 해외주식에도 투자하면서 지역을 분산하기도 합니다. 단순히 비슷한 여러 종목에 투자하는 것이 아니라 업종이나 지역이 다양한 종목을 분산하여 투자함으로서 개별종목 하나하나의 위험을 줄이고 원하는 수익률을 실현하기 위한 노력이 필요합니다. 스스로 여러 종목을 분석하고 관리하기 어렵다면 펀드를 고려하는 것도 방법일 수 있습니다."};
	...
	public Map<String, String> makeInvestMainComment(int profileScore, int tracingScore)
	{
		...
		String[] investMainComment = {
				...
				+ "워렌 버핏은 \"실패하는 투자자가 가장 잘못하고 있는 것은 기존의 잘못된 견해들이 유지되도록 새로운 정보를 부정하는 것이다.\"라고 했습니다. 나만의 투자원칙을 공고히 하되 다각적으로 분석하고 객관적인 의사결정을 한다면 좋은 투자를 이어갈 수 있을겁니다.;",
				...
				"“투자원칙을 가진 감정적 투자자”는 포트폴리오 구성, 매매/매수 시점 등 자신만의 투자 기준을 가지고 있지만, 때로 급격한 상황변화나 새로운 정보로 기존의 결정이 바뀌는 경우가 있습니다."
				+ "투자 지식과 경험이 쌓인다면, 여러 변수가 발생하더라도 상황을 객관적으로 파악할 수 있는 눈이 생길 수 있습니다.",
				"\"투자원칙 정립이 필요한 이성적 투자자\"는 인지적 편향의 영향은 상대적으로 적지만, 투자고수가 되기 위해서는 아직은 투자 경험과 지식축적이 요구됩니다. 객관적인 분석에 근거한 투자 결정을 지향하지만 투자원칙이 확고하지 않은 상태에서 투자를 하게되면 작은 변동성에도 불안하거나 크게 흔들릴 수 있습니다. 하지만 학습과 투자경험이 쌓여가고 나만의 투자원칙을 하나씩 장착한다면 흔들림 없이 투자를 이어갈 수 있을겁니다.",
				"\"투자원칙 정립이 필요한 감정적 투자자\"는 아직은 투자경험과 지식이 부족하여 나만의 투자원칙이 정립되지 않은 경향이 있습니다. 투자원칙이 잡히지 않은 상태에서 투자를 하게되면 심리적 안정을 얻기 힘들고 작은 변동성에도 불안해하거나 크게 흔들릴 수밖에 없습니다. 첫 스타트가 중요합니다. 자신이 투자하는 방법을 스스로 믿고 행동할 수 있도록 나만의 원칙을 세우고 하나씩 시작하는 습관이 중요할 수 있습니다.",
