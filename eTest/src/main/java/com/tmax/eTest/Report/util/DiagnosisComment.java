...
public class DiagnosisComment {
	...
	{
		String[] investType = {
				"투자원칙이 명확하고 이성적이며 행동편향이 낮은 투자자",			//45 55
				"투자원칙이 명확하고 이성적이며 행동편향이 낮은 투자자",			//45 45
				"투자원칙은 확고하지 않지만 이성적이며 행동편향은 보통인 투자자",	//45 36
				"투자원칙은 확고하지 않지만 이성적이며 행동편향은 보통인 투자자",
				"투자원칙은 없고 행동편향은 높지만 이성적인 투자자",
				
				"투자원칙이 명확하고 이성적이며 행동편향이 낮은 투자자",			//40
				"투자원칙이 명확하고 이성적이며 행동편향이 낮은 투자자",
				"투자원칙은 확고하지 않지만 이성적이며 행동편향은 보통인 투자자",
				"투자원칙은 확고하지 않지만 이성적이며 행동편향은 높은 투자자",
				"투자원칙은 없고 행동편향은 높지만 이성적인 투자자",
				
				"투자원칙은 명확하고 행동편향이 낮지만 감정적인 투자자",			//35
				...
				"투자원칙은 명확하고 행동편향이 낮지만 감정적인 투자자",			//30
				"투자원칙은 명확하지만 감정적이며 행동편향은 보통인 투자자",
				"투자원칙은 확고하지 않고 감정적이며 행동편향이 높은 투자자",
				"투자원칙은 확고하지 않고 감정적이며 행동편향이 높은 투자자",
				"투자원칙은 없고 감정적이며 행동편향이 매우 높은 투자자",
				
				"투자원칙은 명확하지만 보통의 행동편향을 가진 충동적인 투자자",		//25
				...
				"투자원칙은 명확하지만 보통의 행동편향을 가진 충동적인 투자자",		//20
	...
	public Map<String, String> makeKnowledgeMainComment(int knowledgeScore)
	{
		...
		String[] knowledgeMain = {"우수", "보통", "부족"};
		String[] knowledgeDetail = {"우수", "보통", "부족"};
			...
			int sellScore)
	{
		...
		String[] commonCommentList = {
				"당신은 투자기초 영역에 대한 지식을 갖추고 있습니다. 투자 시작을 위한 기본적인 준비는 되어 있는 것으로 보이시네요.", 
				"보통",
				"부족"};
	...
	public Map<String, String> makeRiskMainComment(int profileScore, int tracingScore)
	{
		...
		String[] riskMainComment = {
				...
				"엇박자 공격형 투자자",
				"하이브리드 공격형 투자자",
				"“하이브리드형 투자자”는 공격적일때는 공격적으로, 보수적일때는 보수적으로 상황에 맞게 투자방법을 결정하는 경향이 있습니다. "
				+ "대체로 내가 감당할 수 있는 범위 내에서 투자하는 것을 선호하며, 나의 위험성향과 실제 투자 방식이 상당부분 일치하기 "
				+ "때문에 주변 사람들이 봤을때는 안정적으로 투자하는 사람으로 보이기도 합니다.",
				"하이브리드 방어형 투자자",
				"엇박자 방어형 투자자",
				"2% 부족한 방어형 투자자",
				"전형적인 방어형 투자자"};
	...
	{
		String[] profileMainList = {"리스크 선호형", 
				"너무 큰 위험도 너무 작은 위험도 추구하지 않는, 중립형 투자자", 
				"리스크 회피형"};
		...
		String[] profileDetailList = {
				"리스크 선호형", 
				"당신은 리스크 중립형으로 위험을 적당하게 수용하고 인내하는 투자자입니다.", 
				"리스크 회피형"};
		String[] tracingDetailList = {
				"집중형 투자자", 
				"당신은 집중할때는 집중하고 분산할때는 분산하기도 하지만, 남들과 비슷한 수준의 분산 투자를 하는 경향이 있습니다.", 
				"분산형 투자자"};
