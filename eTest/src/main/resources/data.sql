...
---------------------PROBLEM------------------------
insert into "ETEST"."PROBLEM" ("PROB_ID", "ANSWER_TYPE", "CATEGORY", "CREATE_DATE", "CREATOR_ID", "DIFFICULTY", "EDIT_DATE", "EDITOR_ID", "IMG_SRC", "INTENTION", "PART", "QUESTION", "SOLUTION", "SOURCE", "TIME_RECOMMENDATION", "VALIDATE_DATE", "VALIDATOR_ID" ) values (1, '객관식', null, TO_DATE('2021/05/28 10:44:43', 'YYYY/MM/DD HH24:MI:SS'), '김두희111', '중', null, null, null, '그냥', '2', '생애 처음으로 투자를 시작하는 개인투자자 A씨가 투자를 위해 한 행동 중에 현행 제도와 가장 거리가 먼 것은?', '{"answer":[4],"solution": "지문1 우체국에서 주식매매를 위한 위탁계좌를 개설할 수 있다.
...
insert into "ETEST"."PROBLEM" ("PROB_ID", "ANSWER_TYPE", "CATEGORY", "CREATE_DATE", "CREATOR_ID", "DIFFICULTY", "EDIT_DATE", "EDITOR_ID", "IMG_SRC", "INTENTION", "PART", "QUESTION", "SOLUTION", "SOURCE", "TIME_RECOMMENDATION", "VALIDATE_DATE", "VALIDATOR_ID" ) values (2, '객관식', null, TO_DATE('2021/05/28 10:44:43', 'YYYY/MM/DD HH24:MI:SS'), '김두희222', '중', null, null, null, '그냥', '1', '투자자 A씨가 온라인에서 본 유사투자자문업자의 행동(광고)중에 현행자본시장법에 비추어 가장 올바른 것은?', '{"answer":[2],"solution": "지문1 유사투자자문업은 자본시장법 101조(유사투자자문업의 신고)에 따라 금융위원회에 신고한 자는 합법적인 유사투자자문업자다. 관련 규정을 어긴 자만 불법이다.
...
insert into "ETEST"."PROBLEM" ("PROB_ID", "ANSWER_TYPE", "CATEGORY", "CREATE_DATE", "CREATOR_ID", "DIFFICULTY", "EDIT_DATE", "EDITOR_ID", "IMG_SRC", "INTENTION", "PART", "QUESTION", "SOLUTION", "SOURCE", "TIME_RECOMMENDATION", "VALIDATE_DATE", "VALIDATOR_ID" ) values (3, '객관식', null, TO_DATE('2021/05/28 10:44:43', 'YYYY/MM/DD HH24:MI:SS'), '김두희333', '중', null, null, null, '재밌어서', '3', '공모주와 스팩(SPAC)투자에 대한 설명으로 가장 거리가 먼 것은?', '{"answer":[2],"solution": "지문1 공모주 청약을 위해서는 금융투자회사를 통해서 청약을 하고, 배정받는 주식을 보유하거나 매매를 통해 이익을 얻을 수 있다. 따라서 증권회사의 계좌는 반드시 있어야 청약이 가능하다.
